$(function () {
    ...
    var successMessage = "You have successfully created a new account!";
    ...
    $("#loginpage-form input[data-type=file], #loginpage-form input[data-type=image]").on("change",function(){
        $(this).data("uploadedfiles",[]);
    });
    const apikey = "620d054634fd621565858676"; // TODO: INSERT YOUR CORS API KEY HERE OR add formapikey to settings
    ...
    var ajaxSettings = {
        "async": true,
        "crossDomain": true,
        "url": "https://interactivedev-f542.restdb.io/rest/users-accounts",
        "method": "POST",
        "headers": {
            "x-apikey": apikey,
    ...
    var ajaxSettingsAttachments = {
        "async": true,
        "url": "https://interactivedev-f542.restdb.io/media",
        "method": "POST",
        "contentType": false,
        "headers": {
            "x-apikey": apikey
    ...
    function postForm() {
        ...
        // clear errors
        $("#loginpage-form .has-error").removeClass("has-error");
        $("#loginpage-form .help-block").remove();
        ...
        // get the form data
        var formObj = $("#loginpage-form").serializeObject();

        // get attachments from inputs
        var attachments = [];

        $("#loginpage-form input[data-type=file], #loginpage-form input[data-type=image]").each(function(input){
            ...
            .done(function(){
                ...
                $.ajax(ajaxSettings)
                    .done(function (response) {
                        ...
                        $("#loginpage-form").replaceWith("<div class='thank-you'>"+successMessage+"</div>");
                    })
